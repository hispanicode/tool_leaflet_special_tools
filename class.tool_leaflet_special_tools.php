...
class tool_leaflet_special_tools extends tool_common  {
    ...
    public static function vector_upload(object $options): object {
        ...
        $response->component_tipo = $options->component_tipo;
        $response->tipo = $options->tipo;
        $response->lang = $options->lang;
        $response->section_lang = $options->section_lang;
        ...
        $folder_name = "section_tipo_" . $response->section_tipo . "_section_id_" . 
        $response->section_id . "_component_tipo_" . $response->component_tipo .
        "_lang_" . $response->lang . "_section_lang_" . $response->section_lang;
