        ...
        L.DomEvent.addListener(controlDiv, 'click', function(){
            ...
            onShow: function(evt) {
                ...
                tool.google_translate({
                    ...
                    str: "Consulta a servicios relacionados con el Imperio Romano", 
                    lang: lang
                ...
                modal_body.appendChild(pleiades_title);
                ...
                modal_body.appendChild(pleiades_div);
                ...
                btn_pleiades_img.src = tool.controls_url() + '/leaflet.control.SpecialToolsRomanEmpire/img/search.png';
                ...
                L.DomEvent.on(btn_pleiades, 'click', function() {
                    ...
                    const radio_option_checked = modal._container.querySelector('input[name="radio_pleiades"]:checked').value;
                    const input_value = special_tools.simple_sanitize_string(search_pleiades.value);
                    const pleiades_array = modal._container.querySelectorAll('.get-pleiades');
                    const p_pleiades_array = modal._container.querySelectorAll('.p-get-pleiades');
                    ...
                    let promise = tool.get_pleiades_json(options);
             
                    promise.then(function(json){
                        
                        if (!json.success) {

                            special_tools.modal_message(special_tools, json.msg, lang);
                        ...
                        for (let index in json_content) {
                            ...
                            L.DomEvent.on(get_pleiades, 'click', function(){
                                ...
                                let promise = tool.get_pleiades_service(options);
                                    ...
                                    if (data.success) {
                                        ...
                                        if (content.hasOwnProperty('features')) {
                                            ...
                                            if (first_feature_type === 'Point') {
                                                ...
                                                special_tools.modal_message(special_tools, "Objeto creado con éxito", lang);
                                            ...
                                            for (let index = 1; index < content.features.length; index++) {
                                                ...
                                                if (feature_type === 'LineString') {
                                                    ...
                                                    const multi_id = special_tools.make_id(20);
                                                    ...
                                                    for (let index in coordinates) {
                                                        ...
                                                        const tools_id = special_tools.make_id(20);
                ...
                modal_body.appendChild(pelagios_title);
                ...
                modal_body.appendChild(pelagios_div);
                ...
                btn_pelagios_img.src = tool.controls_url() + '/leaflet.control.SpecialToolsRomanEmpire/img/search.png';
                ...
                pelagios_div.appendChild(clear_div.cloneNode(true));
                ...
                L.DomEvent.on(btn_pelagios, 'click', function() {
                    ...
                    const query = special_tools.simple_sanitize_string(search_pelagios.value);
                    const pelagios_array = modal._container.querySelectorAll('.get-pelagios');   
                    const p_pelagios_array = modal._container.querySelectorAll('.p-get-pelagios');
                    ...
                    let promise = tool.get_pelagios(options);
                ...
                modal_body.appendChild(imperium_title);
                ...
                modal_body.appendChild(imperium_div);
                ...
                btn_imperium_img.src = tool.controls_url() + '/leaflet.control.SpecialToolsRomanEmpire/img/search.png';
                ...
                imperium_div.appendChild(clear_div.cloneNode(true));
                ...
                L.DomEvent.on(btn_imperium, 'click', function() {
                    ...
                    const query = special_tools.simple_sanitize_string(modal._container.querySelector('#search_imperium').value);
                    const imperium_array = modal._container.querySelectorAll('.get-imperium');
                    const p_imperium_array = modal._container.querySelectorAll('.p-get-imperium');
                    ...
                    let promise = tool.get_imperium_ahlfeldt(options);
                    ...
                    promise.then(function(data) {
                        ...
                        for (let index in content) {
                            ...
                            try {
                                ...
                                if (typeof get_imperium === 'undefined') return;
