                ...
                onShow: function(evt) {
                    ...
                    L.DomEvent.on(open_vector_modal, 'click', function(e) {
                        ...
                        try {
                            ...
                            map._container.querySelector('#modal_image').remove();
                                    ...
                                    if (data.type === 'application/zip') {
                                        ...
                                        shpfile.once("data:loaded", function() {
                                            ...
                                            window.setTimeout(function() {
                                                ...
                                                map._container.querySelector('#modal_vector').remove();
                            ...
                            tool.image_subscribe(
                                ...
                                function(response) {
                                    ...
                                    const options = {
                                        ...
                                        file_data: response.file_data,
                                        tipo: tool.get_component_image().tipo,
                                        section_tipo: tool.get_component_image().section_tipo,
                                        section_id: tool.get_component_image().section_id,
                                        default_quality: tool.get_component_image().context.features.default_target_quality
