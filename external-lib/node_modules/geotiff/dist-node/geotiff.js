...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.fromUrl=b,exports.fromArrayBuffer=A,exports.fromFile=O,exports.fromBlob=D,exports.fromUrls=S,exports.writeArrayBuffer=x,Object.defineProperty(exports,"Pool",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(exports,"getDecoder",{enumerable:!0,get:function(){return l.getDecoder}}),Object.defineProperty(exports,"setLogger",{enumerable:!0,get:function(){return f.setLogger}}),exports.rgb=exports.globals=exports.MultiGeoTIFF=exports.default=exports.GeoTIFF=void 0;var e=d(require("./geotiffimage")),t=d(require("./dataview64")),r=d(require("./dataslice")),i=d(require("./pool")),s=require("./source"),a=u(require("./globals"));exports.globals=a;var n=require("./geotiffwriter"),o=u(require("./rgb"));exports.rgb=o;var l=require("./compression"),f=require("./logging");function c(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return c=function(){return e},e}function u(e){if(e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var t=c();if(t&&t.has(e))return t.get(e);var r={},i=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var s in e)if(Object.prototype.hasOwnProperty.call(e,s)){var a=i?Object.getOwnPropertyDescriptor(e,s):null;a&&(a.get||a.set)?Object.defineProperty(r,s,a):r[s]=e[s]}return r.default=e,t&&t.set(e,r),r}function d(e){return e&&e.__esModule?e:{default:e}}function h(e){switch(e){case a.fieldTypes.BYTE:case a.fieldTypes.ASCII:case a.fieldTypes.SBYTE:case a.fieldTypes.UNDEFINED:return 1;case a.fieldTypes.SHORT:case a.fieldTypes.SSHORT:return 2;case a.fieldTypes.LONG:case a.fieldTypes.SLONG:case a.fieldTypes.FLOAT:case a.fieldTypes.IFD:return 4;case a.fieldTypes.RATIONAL:case a.fieldTypes.SRATIONAL:case a.fieldTypes.DOUBLE:case a.fieldTypes.LONG8:case a.fieldTypes.SLONG8:case a.fieldTypes.IFD8:return 8;default:throw new RangeError(`Invalid field type: ${e}`)}}function g(e){const t=e.GeoKeyDirectory;if(!t)return null;const r={};for(let i=4;i<=4*t[3];i+=4){const s=a.geoKeyNames[t[i]],n=t[i+1]?a.fieldTagNames[t[i+1]]:null,o=t[i+2],l=t[i+3];let f=null;if(n){if(null==(f=e[n]))throw new Error(`Could not get value of geoKey '${s}'.`);"string"==typeof f?f=f.substring(l,l+o-1):f.subarray&&(f=f.subarray(l,l+o),1===o&&(f=f[0]))}else f=l;r[s]=f}return r}function y(e,t,r,i){let s=null,n=null;const o=h(t);switch(t){case a.fieldTypes.BYTE:case a.fieldTypes.ASCII:case a.fieldTypes.UNDEFINED:s=new Uint8Array(r),n=e.readUint8;break;case a.fieldTypes.SBYTE:s=new Int8Array(r),n=e.readInt8;break;case a.fieldTypes.SHORT:s=new Uint16Array(r),n=e.readUint16;break;case a.fieldTypes.SSHORT:s=new Int16Array(r),n=e.readInt16;break;case a.fieldTypes.LONG:case a.fieldTypes.IFD:s=new Uint32Array(r),n=e.readUint32;break;case a.fieldTypes.SLONG:s=new Int32Array(r),n=e.readInt32;break;case a.fieldTypes.LONG8:case a.fieldTypes.IFD8:s=new Array(r),n=e.readUint64;break;case a.fieldTypes.SLONG8:s=new Array(r),n=e.readInt64;break;case a.fieldTypes.RATIONAL:s=new Uint32Array(2*r),n=e.readUint32;break;case a.fieldTypes.SRATIONAL:s=new Int32Array(2*r),n=e.readInt32;break;case a.fieldTypes.FLOAT:s=new Float32Array(r),n=e.readFloat32;break;case a.fieldTypes.DOUBLE:s=new Float64Array(r),n=e.readFloat64;break;default:throw new RangeError(`Invalid field type: ${t}`)}if(t!==a.fieldTypes.RATIONAL&&t!==a.fieldTypes.SRATIONAL)for(let a=0;a<r;++a)s[a]=n.call(e,i+a*o);else for(let a=0;a<r;a+=2)s[a]=n.call(e,i+a*o),s[a+1]=n.call(e,i+(a*o+4));return t===a.fieldTypes.ASCII?String.fromCharCode.apply(null,s):s}class p{constructor(e,t,r){this.fileDirectory=e,this.geoKeyDirectory=t,this.nextIFDByteOffset=r}}class w extends Error{constructor(e){super(`No image at index ${e}`),this.index=e}}class T{async readRasters(e={}){const{window:t,width:r,height:i}=e;let{resX:s,resY:a,bbox:n}=e;const o=await this.getImage();let l=o;const f=await this.getImageCount(),c=o.getBoundingBox();if(t&&n)throw new Error('Both "bbox" and "window" passed.');if(r||i){if(t){const[e,r]=o.getOrigin(),[i,s]=o.getResolution();n=[e+t[0]*i,r+t[1]*s,e+t[2]*i,r+t[3]*s]}const e=n||c;if(r){if(s)throw new Error("Both width and resX passed");s=(e[2]-e[0])/r}if(i){if(a)throw new Error("Both width and resY passed");a=(e[3]-e[1])/i}}if(s||a){const e=[];for(let t=0;t<f;++t){const r=await this.getImage(t),{SubfileType:i,NewSubfileType:s}=r.fileDirectory;(0===t||2===i||1&s)&&e.push(r)}e.sort((e,t)=>e.getWidth()-t.getWidth());for(let t=0;t<e.length;++t){const r=e[t],i=(c[2]-c[0])/r.getWidth(),n=(c[3]-c[1])/r.getHeight();if(l=r,s&&s>i||a&&a>n)break}}let u=t;if(n){const[e,t]=o.getOrigin(),[r,i]=l.getResolution(o);u=[Math.round((n[0]-e)/r),Math.round((n[1]-t)/i),Math.round((n[2]-e)/r),Math.round((n[3]-t)/i)],u=[Math.min(u[0],u[2]),Math.min(u[1],u[3]),Math.max(u[0],u[2]),Math.max(u[1],u[3])]}return l.readRasters({...e,window:u})}}class m extends T{constructor(e,t,r,i,s={}){super(),this.source=e,this.littleEndian=t,this.bigTiff=r,this.firstIFDOffset=i,this.cache=s.cache||!1,this.ifdRequests=[],this.ghostValues=null}async getSlice(e,t){const i=this.bigTiff?4048:1024;return new r.default(await this.source.fetch(e,void 0!==t?t:i),e,this.littleEndian,this.bigTiff)}async parseFileDirectoryAt(e){const t=this.bigTiff?20:12,r=this.bigTiff?8:2;let i=await this.getSlice(e);const s=this.bigTiff?i.readUint64(e):i.readUint16(e),n=s*t+(this.bigTiff?16:6);i.covers(e,n)||(i=await this.getSlice(e,n));const o={};let l=e+(this.bigTiff?8:2);for(let u=0;u<s;l+=t,++u){const e=i.readUint16(l),t=i.readUint16(l+2),r=this.bigTiff?i.readUint64(l+4):i.readUint32(l+4);let s,n;const f=h(t),c=l+(this.bigTiff?12:8);if(f*r<=(this.bigTiff?8:4))s=y(i,t,r,c);else{const e=i.readOffset(c),a=h(t)*r;if(i.covers(e,a))s=y(i,t,r,e);else{s=y(await this.getSlice(e,a),t,r,e)}}n=1===r&&-1===a.arrayFields.indexOf(e)&&t!==a.fieldTypes.RATIONAL&&t!==a.fieldTypes.SRATIONAL?s[0]:s,o[a.fieldTagNames[e]]=n}const f=g(o),c=i.readOffset(e+r+t*s);return new p(o,f,c)}async requestIFD(e){if(this.ifdRequests[e])return this.ifdRequests[e];if(0===e)return this.ifdRequests[e]=this.parseFileDirectoryAt(this.firstIFDOffset),this.ifdRequests[e];if(!this.ifdRequests[e-1])try{this.ifdRequests[e-1]=this.requestIFD(e-1)}catch(t){if(t instanceof w)throw new w(e);throw t}return this.ifdRequests[e]=(async()=>{const t=await this.ifdRequests[e-1];if(0===t.nextIFDByteOffset)throw new w(e);return this.parseFileDirectoryAt(t.nextIFDByteOffset)})(),this.ifdRequests[e]}async getImage(t=0){const r=await this.requestIFD(t);return new e.default(r.fileDirectory,r.geoKeyDirectory,this.dataView,this.littleEndian,this.cache,this.source)}async getImageCount(){let e=0,t=!0;for(;t;)try{await this.requestIFD(e),++e}catch(r){if(!(r instanceof w))throw r;t=!1}return e}async getGhostValues(){const e=this.bigTiff?16:8;if(this.ghostValues)return this.ghostValues;const t="GDAL_STRUCTURAL_METADATA_SIZE=",r=t.length+100;let i=await this.getSlice(e,r);if(t===y(i,a.fieldTypes.ASCII,t.length,e)){const t=y(i,a.fieldTypes.ASCII,r,e).split("\n")[0],s=Number(t.split("=")[1].split(" ")[0])+t.length;s>r&&(i=await this.getSlice(e,s));const n=y(i,a.fieldTypes.ASCII,s,e);this.ghostValues={},n.split("\n").filter(e=>e.length>0).map(e=>e.split("=")).forEach(([e,t])=>{this.ghostValues[e]=t})}return this.ghostValues}static async fromSource(e,r){const i=await e.fetch(0,1024),s=new t.default(i),a=s.getUint16(0,0);let n;if(18761===a)n=!0;else{if(19789!==a)throw new TypeError("Invalid byte order value.");n=!1}const o=s.getUint16(2,n);let l;if(42===o)l=!1;else{if(43!==o)throw new TypeError("Invalid magic number.");if(l=!0,8!==s.getUint16(4,n))throw new Error("Unsupported offset byte-size.")}const f=l?s.getUint64(8,n):s.getUint32(4,n);return new m(e,n,l,f,r)}close(){return"function"==typeof this.source.close&&this.source.close()}}exports.GeoTIFF=m;var I=m;exports.default=I;class F extends T{constructor(e,t){super(),this.mainFile=e,this.overviewFiles=t,this.imageFiles=[e].concat(t),this.fileDirectoriesPerFile=null,this.fileDirectoriesPerFileParsing=null,this.imageCount=null}async parseFileDirectoriesPerFile(){const e=[this.mainFile.parseFileDirectoryAt(this.mainFile.firstIFDOffset)].concat(this.overviewFiles.map(e=>e.parseFileDirectoryAt(e.firstIFDOffset)));return this.fileDirectoriesPerFile=await Promise.all(e),this.fileDirectoriesPerFile}async getImage(t=0){await this.getImageCount(),await this.parseFileDirectoriesPerFile();let r=0,i=0;for(let s=0;s<this.imageFiles.length;s++){const a=this.imageFiles[s];for(let n=0;n<this.imageCounts[s];n++){if(t===r){const t=await a.requestIFD(i);return new e.default(t.fileDirectory,a.geoKeyDirectory,a.dataView,a.littleEndian,a.cache,a.source)}r++,i++}i=0}throw new RangeError("Invalid image index")}async getImageCount(){if(null!==this.imageCount)return this.imageCount;const e=[this.mainFile.getImageCount()].concat(this.overviewFiles.map(e=>e.getImageCount()));return this.imageCounts=await Promise.all(e),this.imageCount=this.imageCounts.reduce((e,t)=>e+t,0),this.imageCount}}async function b(e,t={}){return m.fromSource((0,s.makeRemoteSource)(e,t))}async function A(e){return m.fromSource((0,s.makeBufferSource)(e))}async function O(e){return m.fromSource((0,s.makeFileSource)(e))}async function D(e){return m.fromSource((0,s.makeFileReaderSource)(e))}async function S(e,t=[],r={}){const i=await m.fromSource((0,s.makeRemoteSource)(e,r)),a=await Promise.all(t.map(e=>m.fromSource((0,s.makeRemoteSource)(e,r))));return new F(i,a)}async function x(e,t){return(0,n.writeGeotiff)(e,t)}exports.MultiGeoTIFF=F;
