L.Control.GraphicScale = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        var compass = L.DomUtil.create('div', 'leaflet-control-compass');
        compass.style.width = '40px';
        compass.style.height = '40px';
        compass.style.backgroundColor = 'yellow';
        
        this._scale = this._addScale(compass);
    ...
    _buildScale: function() {
        ...
        var compass = L.DomUtil.create('div', 'leaflet-control-compass', root);
        compass.style.width = '40px';
        compass.style.height = '40px';
        compass.style.backgroundColor = 'yellow';
